...
export default function PostsPage() {
  ...
  return (
    ...
    >
      ...
      <main className="w-full px-6 md:px-[90px] pt-16 pb-24 font-nunito">
        {/* Header */}
        <div className="mb-14">
          ...
          <h1 className="font-bold font-lora text-[rgb(42,24,37)] leading-tight" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)' }}>
            All <em className="text-[rgb(201,52,126)]">posts</em>
          </h1>
        </div>
        ...
        <div className="flex flex-col gap-6 max-w-[860px]">
          {posts.map((post) => (
            ...
            >
              ...
              {/* Title */}
              <h2 className="font-semibold font-lora text-[rgb(42,24,37)] leading-snug mb-2 group-hover:text-[rgb(201,52,126)] transition-colors" style={{ fontSize: 'clamp(1.1rem, 2vw, 1.5rem)' }}>
                {post.title}
              </h2>
              ...
              {/* Meta */}
              <div className="flex items-center gap-3 text-[rgb(137,112,120)] text-[12px] font-nunito">
                <span>
