      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-14 pb-10 mb-8 border-b border-[rgba(246,240,220,0.18)]">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <div className="flex flex-wrap gap-3">
            {['Instagram', 'Ravelry', 'Pinterest', 'Substack'].map(name => (
              <a key={name} href="#" data-link="true" className="relative text-[rgb(240,182,82)] text-[12px] font-semibold px-[14px] py-2 rounded-full border border-[rgba(240,182,82,0.3)] cursor-pointer">
                {name}
              </a>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="flex items-center bg-[rgba(246,240,220,0.08)] rounded-full p-1">
            <input
              placeholder="your email"
              className="flex-1 bg-transparent text-[rgb(246,240,220)] px-4 py-2 text-[13px] font-nunito outline-none placeholder:text-[rgba(246,240,220,0.45)]"
            />
            <button data-btn="true" className="bg-[rgb(201,52,126)] text-[rgb(246,240,220)] px-[18px] py-2 text-[12px] font-bold font-nunito rounded-full cursor-pointer shrink-0">
              JOIN
            </button>
          </div>
        </div>
